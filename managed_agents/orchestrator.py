...
# Modelo del agente. Por defecto un modelo eficiente tipo Haiku. Útil para subir
# a un modelo más capaz sin tocar el código (p. ej. AGENT_MODEL=claude-opus-4-8).
